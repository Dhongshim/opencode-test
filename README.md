...
1. Check framework integrity: `opencode-test check --verbose`
...
sudo npm install -g opencode-test
```
...
4. **Check Playwright MCP**: Ensure OpenCode has Playwright integration
...
### Core Components
- **CLI Entry Point**: `bin/opencode-test.js` - Commander.js-based CLI with three main commands
...
- `npm run test:coverage` - Coverage analysis including .opencode/scripts
...
📖 **[opencode-test-demo](https://github.com/terryso/opencode-test-demo)** - Complete usage examples, test cases, and integration guides

## Support

For issues and questions:

- **GitHub Issues**: [Report a bug](https://github.com/terryso/opencode-test/issues)
- **Full Documentation**: [Full Documentation](https://github.com/terryso/opencode-test#readme)
- **Demo Project**: [opencode-test-demo](https://github.com/terryso/opencode-test-demo)
- **OpenCode Docs**: [https://opencode.ai/docs](https://opencode.ai/docs)

## ⭐ Star History

[![Star History Chart](https://api.star-history.com/svg?repos=terryso/opencode-test&type=Date)](https://www.star-history.com/#terryso/opencode-test&Date)
