...
/**
 * opencode-test CLI Entry Point
 * YAML-based Playwright testing framework for OpenCode
 */
...
program
  .name('opencode-test')
  .description('YAML-based Playwright testing framework for OpenCode')
...
program.on('command:*', () => {
  ...
  console.error(chalk.gray('Run "opencode-test --help" for available commands.'));
  process.exit(1);
});
