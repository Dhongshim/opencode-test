...
describe('init command', () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), 'opencode-test-init-'));
  ...
  test('should initialize framework in empty directory', async () => {
    ...
    // Check if .opencode directory was created
    ...
    expect(versionData.installSource).toBe('opencode-test-cli');
  });
  ...
  test('should handle initialization errors gracefully', async () => {
    ...
    const mockCopyFrameworkFiles = jest
      .spyOn(FileManager, 'copyFrameworkFiles')
