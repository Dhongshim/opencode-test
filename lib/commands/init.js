...
async function init(options = {}) {
  const spinner = ora('Initializing opencode-test framework...').start();
  ...
  try {
    ...
    if (options.verbose && process.env.NODE_ENV !== 'test') {
      spinner.stop();
      console.log(chalk.blue('🚀 Initializing opencode-test framework...'));
    ...
    if (frameworkExists && !options.force) {
      ...
      console.log(chalk.gray('Use --force to reinitialize or run "opencode-test update" to update.'));
    ...
    if (process.env.NODE_ENV !== 'test') {
      ...
      console.log(chalk.cyan('   ls .opencode/commands/'));
      ...
      console.log(chalk.cyan('   opencode-test check'));
    }
